...
const Page = () => {
  const Images = useStaticQuery(graphql`
    query {
      heroImage: file(
        relativePath: { eq: "safer-neighborhoods-in-santa-ana.jpg" }
      ) {
        childImageSharp {
      ...
      oversight: file(
        relativePath: { eq: "safer-neighborhoods-oversight.png" }
      ) {
        childImageSharp {
          fluid(maxWidth: 500) {
            ...GatsbyImageSharpFluid
      ...
      treatment: file(
        relativePath: { eq: "safer-neighborhoods-treatment.png" }
      ) {
        childImageSharp {
          fluid(maxWidth: 500) {
            ...GatsbyImageSharpFluid
      ...
      prevention: file(
        relativePath: { eq: "safer-neighborhoods-prevention.png" }
      ) {
        childImageSharp {
          fluid(maxWidth: 500) {
            ...GatsbyImageSharpFluid
      ...
      <Container>
        <HeroContainer>
          ...
          <Img
            ...
            alt="Downtown Santa Ana, 4th Street"
          />
        </HeroContainer>
        <Content>
          <Wrapper>
            ...
            >
              <Img
                fluid={
                  Images[`${language}_saferNeighborhoods_op0c`].childImageSharp
                    .fluid
                }
          ...
          <Table className="yellow slanted sltr">
            <TableCell>
              <Img
                fluid={Images.response.childImageSharp.fluid}
                alt="People writing reports and responding"
              />
            </TableCell>
            <TableCell>
          ...
          <Table>
            ...
            <TableCell>
              <Img
                fluid={Images.oversight.childImageSharp.fluid}
                alt="People voting in a committee"
              />
            </TableCell>
          </Table>
          <Table className="yellow slanted sltr">
            <TableCell>
              <Img
                fluid={Images.treatment.childImageSharp.fluid}
                alt="Health care works at a treatment center"
              />
            </TableCell>
            <TableCell>
          ...
          <Table>
            ...
            <TableCell>
              <Img
                fluid={Images.prevention.childImageSharp.fluid}
                alt="People performing cost saving maintenance"
              />
            </TableCell>
          </Table>
        </Content>
        <Content style={{ maxWidth: 1040, margin: "30px auto" }}>
          <Video
            src={`https://www.youtube.com/embed/hYxtFIitWJE`}
            title={`Barrios más seguros en Santa Ana`}
          />
        </Content>
      </Container>
    </Layout>
